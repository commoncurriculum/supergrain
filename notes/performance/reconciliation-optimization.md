...
Signals are created on first reactive access (via `getNode`). Reconcile may be needed to sync signals that were created _after_ the mutation that should have updated them.
