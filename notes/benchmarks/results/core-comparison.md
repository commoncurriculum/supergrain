# Core Comparison: @supergrain/core vs solid-js/store
...
|---|---:|---:|---|
| **@supergrain/core** | 1,694 | 0.591 | **7.38x faster** |
...
| Library | ops/sec | Mean (ms) | Relative |
|---|---:|---:|---|
| **@supergrain/core** | 20 | 49.45 | **2.41x faster** |
...
| Library | ops/sec | Mean (ms) | Relative |
|---|---:|---:|---|
| **@supergrain/core** | 2,980 | 0.336 | **1.72x faster** |
...
| Library | ops/sec | Mean (ms) | Relative |
|---|---:|---:|---|
| **@supergrain/core** | 4,375 | 0.229 | **1.64x faster** |
...
| Library | ops/sec | Mean (ms) | Relative |
|---|---:|---:|---|
| **@supergrain/core** | 394,883 | 0.003 | **~39,709x faster** |
...
| Library | ops/sec | Mean (ms) | Relative |
|---|---:|---:|---|
| **@supergrain/core** | 72,788 | 0.014 | **~7,375x faster** |
