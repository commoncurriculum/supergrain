...
```javascript
// What we measured:
proxyState.count; proxyState.value; proxyState.text;
// vs
countSignal(); valueSignal(); textSignal();
```
...
```javascript
// What we measured:
proxyState.user.profile.name; proxyState.user.profile.address.city;
// vs
userSignal().profile.name; userSignal().profile.address.city;
```
