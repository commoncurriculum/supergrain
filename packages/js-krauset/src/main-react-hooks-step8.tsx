import { memo, useReducer, useMemo, createContext, useContext } from 'react'
...
// OPTIMIZATION 7: useMemo the entire row list to avoid reconciliation work
export const App = () => {
  ...
  // Memoize the entire row list - React skips reconciliation entirely if this doesn't change
