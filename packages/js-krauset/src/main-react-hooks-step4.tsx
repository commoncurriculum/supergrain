import { memo, useReducer, createContext, useContext, useMemo } from 'react'
...
// OPTIMIZATION 3: Create context with stable dispatch functions
const DispatchContext = createContext(null)

const DispatchProvider = ({ children, dispatch }) => {
  // Memoize action creators to provide stable references
