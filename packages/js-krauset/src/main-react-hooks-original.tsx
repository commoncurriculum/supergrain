...
// Global state for testing interface
...
export const updateStore = updates => {
  if ('$set' in updates) {
    ...
    if ('data' in setOps && 'selected' in setOps) {
      globalDispatch({ type: 'RUN', count: setOps.data.length })
      return
    }
...
const Row = memo(({ item, selected, onSelect, onRemove }) => {
  return (
...
export const add = () => globalDispatch({ type: 'ADD' })
export const update = () => globalDispatch({ type: 'UPDATE' })
export const clear = () => globalDispatch({ type: 'CLEAR' })
export const swapRows = () => globalDispatch({ type: 'SWAPROWS' })
export const remove = id => globalDispatch({ type: 'REMOVE', id })
export const select = id => globalDispatch({ type: 'SELECT', id })
