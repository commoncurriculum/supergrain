...
describe('React Hooks Step 6 Performance Tests', () => {
  ...
  it('should run complete performance suite', async () => {
    console.log('\n🚀 REACT HOOKS STEP 6 PERFORMANCE SUITE RESULTS 🚀')
    console.log('====================================================')
    ...
    console.log('\n📊 COMPARISON WITH ALL STEPS')
    console.log('=============================')
    console.log(`Step 1 (Baseline):        857.20ms`)
    console.log(`Step 2 (useCallback):     877.70ms (+2.4% slower)`)
    console.log(`Step 3 (dispatch in Row): 1007.20ms (+17.5% slower)`)
    console.log(`Step 4 (Context):         851.80ms (-0.6% faster) 🏆 BEST`)
    console.log(`Step 5 (No memo):         941.90ms (+9.9% slower)`)
    console.log(`Step 6 (Custom hook):     ${total.toFixed(2)}ms`)

    if (total < 851.8) {
      console.log(
        `🚀 NEW CHAMPION! Step 6 is ${(((851.8 - total) / 851.8) * 100).toFixed(
          1
        )}% faster than Step 4!`
      )
    } else if (total < 857.2) {
      console.log(
        `✅ Step 6 is ${(((857.2 - total) / 857.2) * 100).toFixed(
          1
        )}% faster than baseline!`
      )
    } else {
      console.log(
        `❌ Step 6 is ${(((total - 857.2) / 857.2) * 100).toFixed(
          1
