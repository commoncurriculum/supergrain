...
// OPTIMIZATION 6: Fragments with stable callback refs outside component
...
export const App = () => {
  ...
  // Create stable callbacks at the app level
  ...
  // Use React.Fragment (no extra provider component)
  return (
    <>
      {state.data.map(item => (
        <Row
