...
- 89eb5f7: Add an `allowNullIntermediates` option to `update()`.
...
- 5929d16: Prototype fidelity: mill no longer imposes `Object.prototype` on documents that don't use it.
...
- fa2bf7f: Rewrite `@supergrain/mill` as a data-first MongoDB update engine.
